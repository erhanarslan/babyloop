...
export function AuthSurfaceGuide({ kind }: AuthSurfaceGuideProps) {
  ...
  return (
    <PageContainer className="auth-surface-guide-container" ariaLabel={`${config.title} guidance`}>
      <Card as="section" className="auth-surface-guide">
        <div className="auth-surface-guide-header">
          <div>
