...
const topicMatchers: Array<{ pattern: RegExp; topic: string; title: string; sourcePath: string }> = [
  ...
  { pattern: /18 aylık|yaş|ürünler/iu, topic: "age-based-needs", title: "Yaş dönemine göre genel ürün ihtiyaçları", sourcePath: "docs/rag/05-age-based-product-needs.md" },
...
describe("rag eval cases", () => {
  it("covers at least 20 assistant quality cases", () => {
    expect(ragEvalCases).toHaveLength(20);
  });
