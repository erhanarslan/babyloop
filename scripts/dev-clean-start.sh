...
export RAG_GOVERNANCE_TEXT_PREVIEW_CHARS="${RAG_GOVERNANCE_TEXT_PREVIEW_CHARS:-280}"
export RAG_PLAYGROUND_ENABLED="${RAG_PLAYGROUND_ENABLED:-true}"
export RAG_EVAL_HISTORY_MAX_RUNS="${RAG_EVAL_HISTORY_MAX_RUNS:-20}"
export RAG_REINDEX_ACTION_ENABLED="${RAG_REINDEX_ACTION_ENABLED:-false}"
export ASSISTANT_TOOLS_ENABLED="${ASSISTANT_TOOLS_ENABLED:-true}"
export ASSISTANT_MAX_TOOL_CALLS="${ASSISTANT_MAX_TOOL_CALLS:-3}"
export ASSISTANT_TOOL_TIMEOUT_MS="${ASSISTANT_TOOL_TIMEOUT_MS:-1500}"
