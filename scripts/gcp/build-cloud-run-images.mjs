...
const PUBLIC_BUILD_KEYS = [
  "NEXT_PUBLIC_API_BASE_URL", "NEXT_PUBLIC_SITE_URL", "NEXT_PUBLIC_BACKOFFICE_BASE_URL",
  "NEXT_PUBLIC_LEGAL_OPERATOR_NAME", "NEXT_PUBLIC_LEGAL_CONTACT_EMAIL", "NEXT_PUBLIC_LEGAL_CONTACT_ADDRESS"
];
